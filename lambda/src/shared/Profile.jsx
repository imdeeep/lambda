...
const Profile = () => {
  ...
  return (
    <div className="w-full h-full medium width100vw">
      {user ? (
        <div className="flex gap-10 items-center mt-5 ml-10">
        ...
        <div className="flex gap-10 items-center mt-5 ml-10">
          <div className="flex flex-col items-center gap-1">
            ...
            {edit ? (
              <>
                <button className="bg-[#7678ED] text-white rounded-full px-1 flex items-center gap-1">
                  <MdOutlineFileUpload />
                  Change photo{" "}
                </button>
              </>
            ...
            {edit ? (
              <>
                <input
                  type="text"
                  value={"Jasmin Lowrey"}
                  className="outline-none border rounded px-1 inline-block text-xl light mt-3"
                />
                <br />
              </>
            ) : (
