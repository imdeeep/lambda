  ...
  return (
    <div className="flex lg:flex-row bg-[#E6E6E6] min-h-[100vh]">
      <div className="flex-1 hidden lg:flex flex-col text-black p-8 mt-10 translate-x-[3rem]">
        <h1 className="text-4xl tracking-[-1px] font-bold">Welcome to <span className='text-[#7D7FEE]'>Lambda</span></h1>
        <p className="mt-2 text-lg">A real-time chat application built by <Link href="https://www.linkedin.com/in/mandeepyadav27/" target='_blank' className='underline text-gray-700'>Mandeep</Link>.</p>
      </div>
